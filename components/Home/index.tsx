  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 transform">
        <h2 className="text-[40px] font-bold text-white mb-4 text-center">Todo with NEXT JS</h2>
        ...
        {projects?.map((project, i) => (
          <>
            {formView === i ? (
              ...
              <li key={i} className="flex gap-2 items-center border-2 border-white  text-[20px]  px-2 py-1 rounded-md bg-[rgb(0,0,0,0.5)]">
                ...
                />
                <BsFillTrashFill className="cursor-pointer text-gray-300 hover:text-gray-500" onClick={() => deleteItem(project?.id)} />
              </li>
            )}
          </>
        ))}
